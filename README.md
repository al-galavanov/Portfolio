...
### **Список программ**
- коррекция измеренной температуры с учетом компенсации температуры холодного спая термопары
- считывание величины загрузки питателей печи. Блокировка считывания загрузки при одновременном включении в работу двух питателей
